...
class decemberline: UIViewController, ChartViewDelegate{
    ...
    @IBAction func update(_ sender: Any) {
        print("cool")
           ...
           for date in 1...31 {
               ...
               databaseHandle = ref?.child("Stats").child("December").child(String(date)).child("Active").observe(.value, with: { (snap) in
