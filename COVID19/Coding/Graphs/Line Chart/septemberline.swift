...
class septemberline: UIViewController, ChartViewDelegate{
    ...
    @IBAction func update(_ sender: Any) {
        print("cool")
           ...
           for date in 1...30 {
               ...
               databaseHandle = ref?.child("Stats").child("September").child(String(date)).child("Active").observe(.value, with: { (snap) in
